...
export function PromoBanners({ onBrowseLive, onBrowseAll }: Props) {
  return (
    <div className="promo-banners">
      <div className="promo-card accent-back">
        <div className="promo-eyebrow">In-Play</div>
        <div className="promo-title">Cricket, Live Right Now</div>
        <div className="promo-sub">Ball-by-ball prices moving in real time. Jump into the order book.</div>
